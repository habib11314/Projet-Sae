...
def charger_restaurants_json():
    """Charge les restaurants depuis le fichier JSON (data/restaurants.json)"""
    try:
...
def obtenir_restaurants_par_defaut():
    return [
        {"id": 1, "name": "Burger King", "address": "12 Rue de la Paix, Paris", "lat": "48.8698", "lng": "2.3318", "menu": [{"name": "Whopper", "price": 6.50}, {"name": "Chicken Royal", "price": 5.90}, {"name": "Frites", "price": 2.50}, {"name": "Coca-Cola", "price": 2.00}]},
        {"id": 2, "name": "Pizza Hut", "address": "25 Avenue Montaigne, Paris", "lat": "48.8656", "lng": "2.3054", "menu": [{"name": "Pizza Margherita", "price": 9.90}, {"name": "Pizza 4 Fromages", "price": 11.50}, {"name": "Pizza Pepperoni", "price": 10.90}, {"name": "Salade César", "price": 5.50}]}
    ]
