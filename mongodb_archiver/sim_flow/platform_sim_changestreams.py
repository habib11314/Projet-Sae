...
- Watches for new orders with status 'pending_request'
- Sends requests to restaurants and watches for responses
- Finds available livreurs and watches for delivery acceptances
- Assigns orders and sends notifications to clients
"""
import os
import time
